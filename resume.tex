...
\noindent
\hrulefill \\ [-0.5cm]
\projecttopic{Team Avishkar Hyperloop, C\textcolor{red}{FI}} \hfill \mycal{Oct '22 - Jul'23} 
\begin{itemize}[leftmargin=\myMargin]
    \setlength \itemsep{-0.1em}
    ...
    among over 25 teams globally, and were runner-ups in the Best Sense and Control System award.
\end{itemize}
\vspace{3pt}
...
\item \textbf{AIR 3} in Shaastra CP Potpourri (Mixed-bag coding contest) \\ \small {\textit{[Shaastra is Asia's largest student-run Techfest]}} 
    \item { \textbf{Global Rank 9} in CodeChef Starters 96} 
    \item { \textbf{Global Rank 231} in Codeforces Round 881} 
...
\begin{itemize}[ leftmargin=\myMargin]
    ...
    \item Linear Programming and Combinatorial Optimisation $\dagger$ 
    \item Linear Algebra $\dagger$ 
    \item $\dagger$ - Graduate Level Course
    \item * - Ongoing
\end{itemize}
\end{multicols}
