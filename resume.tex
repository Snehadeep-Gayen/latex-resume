...
\begin{itemize}[leftmargin=\myMargin]
    ...
    \item Used \textbf{RTOS} to collect and store data from over 20 sensors using various communication protocols at \textbf{low latency}.
    \item Demonstrated our Hyperloop Pod in the prestigious \textbf{European Hyperloop Week - Scotland 2023} 
    among over 25 teams globally, and were awarded runner-up in the Best Sense and Control System category.
\end{itemize}
\vspace{3pt}
...
\begin{itemize}[leftmargin=\myMargin]
    \setlength \itemsep{-0.2em}
    \item Developed a Multi-Level Feedback Queue for OS process scheduling.
    \item Designed and implemented a Memory Management Unit with an LRU page replacement policy.
\end{itemize}
\vspace{5pt}
...
\begin{itemize}[leftmargin=\myMargin]
    \setlength \itemsep{-0.2em}
    \item Built a LAN Chat Server from scratch using only C Socket API
    \item Developed a Music Streaming Server and Client using C Socket API and Unix ALSA Library 
\end{itemize}
\vspace{5pt}
