...
\newcommand{\myloc}[1]{\includegraphics[scale=0.7]{loc.png} \myfont{10}{#1}}
...
\noindent
\hrulefill \\ [-0.5cm]
\projecttopic{Software Internship at Optiver Amsterdam} \hfill \mycal{May'10 - Jul'10} 
\begin{itemize}[leftmargin=\myMargin]
    \item Worked as a part of the Quant Research \& Data Team of Optiver Delta1
    \item Added functionality to create TCP/IP filters from session configuration files for the Network Parser and Optimized them for performance
    \item Added functionality to convert timestamps across timezones taking DST changed into consideration
    \item Analysed SQL queries \& designed a new OneTick database with Schema to shift an overburdened PostGres time series database.
\end{itemize}
\vspace{3pt}
...
\item \textbf{Sports:} 
    School Sports Captain for 2018-19, \\
    Awarded 13 medals in various Track \& Field events and Best Athlete U14 in High School \\
    Taekwondo Red Dan II Belt, NSO Athlete at IITM
...
\noindent
\begin{itemize}[leftmargin=\myMargin]
    \item Implemented a fully functional compiler for a subset of Java with Lexical Analyser, Parsing, Type Checking, IR Generation, Register Allocation, Stack Handling, and MIPS code generation
\end{itemize}
\vspace{5pt}
...
\noindent
\hrulefill \\ [-0.5cm]
\projecttopic{MMU with LRU replacement}
\mylink{insert link here}
...
\hrulefill \\ [-0.5cm]
\mylink{insert link here}
\projecttopic{Multi-Level Feedback Queue Scheduler}
\hfill    \textcolor{projDescColor}{\textit{Java}}  \\[0.1cm]
\projectdesc{CS3500 Course Project - Prof. Prashant LA} \hfill \mycal{Jan-May '23} \\
\noindent
\begin{itemize}[leftmargin=\myMargin]
...
\begin{itemize}[leftmargin=\myMargin]
    ...
    by \textit{Bläser, M., Manthey, B. \& Rao, B.V.R.}} and discussed its applications
\end{itemize}
\vspace{5pt}
