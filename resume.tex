...
\item \textbf{Sports:} \vspace{-0.35cm}
    \begin{multicols}{2}
        \begin{itemize}[noitemsep,nolistsep,leftmargin=\myMargin]
        \item Taekwondo Red-II Belt
        \item NSO Athlete at IITM
        \item School Sports Captain 2018-2019
        % \item Awarded 13 medals in various Track \& Field events
        \item Awarded Best Athlete U14 and 13 medals in Track \& Field events
      \end{itemize}
    \end{multicols}
    \vspace{-9pt}
