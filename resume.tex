...
\begin{table}
 ...
 \href{https://www.linkedin.com/in/snehadeep-gayen/}{\includegraphics[scale=0.05]{linkedin.png}} \ \href{https://codeforces.com/profile/Snehadeep}{\includegraphics[scale=0.06]{cf.png} \ } 
            ...
            % &  {\href{https://github.com/Snehadeep-Gayen}{\includegraphics[scale=0.03]{github.png}} \  Snehadeep-Gayen} 
            \\
            \textbf{B. Tech Computer Science and Engineering} 
            \\
            {Indian Institute of Technology, Madras} 
            % &    {\href{https://codeforces.com/profile/Snehadeep}{\includegraphics[scale=0.04]{cf.png}} \ Snehadeep} 
            \\
        \end{tabular}
    \end{minipage}\hfill
\end{table}
...
\noindent
\projecttopic{WiFi Tomography*}  \hfill \textcolor{projDescColor}{\textit{Python}}  \\
...
\begin{itemize}[noitemsep, nolistsep, leftmargin=\myMargin]
    \item WiFi tomography is a low-cost technique to image the environment using WiFi signals.
    \item Working on computational optimisation of Tomographic Reconstruction for outdoor
...
% \item \textbf{Hack CPU \big\vert \   Prof. C Chandra Sekhar} \  \href{https://github.com/Snehadeep-Gayen/Computer-Organisation-and-Architecture-Lab}{\includegraphics[scale=0.03]{download.png}} \hfill {\textit{Verilog} } 
...
% \item \textbf{Simple CPU \big\vert \   Prof. Ayon Chakraborty} \ \href{https://github.com/Snehadeep-Gayen/Simple_CPU_Design}{\includegraphics[scale=0.03]{download.png}} \hfill {\textit{Verilog} } 
% \begin{itemize}[noitemsep,nolistsep]
%     \item Built a combinational 8-bit CPU (from gate level) using HDL (Verilog) as a part of course CS2310
%  \end{itemize}
%  \vspace{5pt}
 
% \item \textbf{Reading Project \& Presentation \big\vert \   Prof. B. V. R. Rao} \ \href{https://docs.google.com/presentation/d/11JGNKZnVHHQ-aGJLIgkdXcnK5qy_xisO/edit?usp=sharing&ouid=111499804735475673896&rtpof=true&sd=true}{\includegraphics[scale=0.03]{download.png}} \hfill {} 
% \begin{itemize}[noitemsep,nolistsep]
%     \item Studied and analysed a research paper (desc. below) on "Smoothed Analysis of Euclidean Partitioning Algorithms" 
%     \item Presented its key insights and implications as a part of course CS6122
%     \item \href{https://doi.org/10.1007/s00453-012-9643-5}{Link to the paper}
%  \end{itemize}
%  \vspace{5pt}

 
% \item \textbf{CC - CENDY algorithm \big \vert \  Prof. M. Narayanan} \ \href{https://github.com/Snehadeep-Gayen/CENDY-Incremental-CC}{\includegraphics[scale=0.03]{download.png}} \hfill {\textit{C++} } 
% \begin{itemize}[noitemsep,nolistsep]
%     \item Studied a research paper on Closeness Centrality and APL in Dynamic Graphs (descr. below) and implemented its algorithm in C++
%     \item C. -C. Yen, M. -Y. Yeh and M. -S. Chen, "An Efficient Approach to Updating Closeness Centrality and Average Path Length in Dynamic Networks" 2013 IEEE 13th Intl. Conf. on Data Mining
%  \end{itemize}
...
\resheading{\subheadingfont{SOFTWARE SKILLS}}
 \begin{itemize}[noitemsep, nolistsep, leftmargin=\myMargin]
  \item \textbf{Languages}: C++, C, HDL (Verilog), Python, Java, HTML, x86, RISC and 8085 ASM, CSS, R
...
\resheading{\subheadingfont{CODING ACHIEVEMENTS}}
 \begin{itemize}[noitemsep, nolistsep, leftmargin=\myMargin]
  \item \textbf{Codeforces} - Max Rating 1678 \textcolor{blue}{Expert}
  \item \textbf{ICPC}: Mathura Prelims AIR 151
\item AIR 3 in Shaastra CP Potpourri (Mixed-bag coding \\ contest) \small {\textit{[Shaastra is Asia's largest student-run Techfest]}}  
    \item \normalsize{Google Farewell Round Global Rank 373} 
    \item \normalsize{Codeforces Round 881 Global Rank 231} 
    \item \normalsize{CodeChef Starters 96 (Div. 3) Global Rank 9} 
...
\noindent
\resheading{\subheadingfont{RELEVANT COURSES}}
...
\begin{itemize}[noitemsep, nolistsep, leftmargin=\myMargin]
  ...
  \item { Programming and \textbf{Data Structures}} 
  \item { Computer Organisation and Architecture} 
  \item { Design \& Analysis of \textbf{Algo}} 
  \item { Theory of Computation} 
  \item { Probabilistic, Smoothed Analysis of Algorithms} 
  \item { Object Oriented Prog.} 
  \item { Discrete Maths} 
  \item { Basic \textbf{Graph Theory}} 
  \item { \textbf{Probability, Statistics} \& Stochastic Processes} 
  \item { Series and Matrices} 
  \item { Multivariable Calculus} 
  \item { Ordinary Differential Eqns}  
  \item { Principles of\textbf{ Economics}} 
  \item { Intro to\textbf{ Game Theory}}   
